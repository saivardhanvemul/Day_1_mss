...
print("users")
print(data["users"])
print(data["users"][27]["height"])
print(data["users"][27]["weight"])
print(data["users"][27]["hair"]["color"])
print(data["users"][27]["address"])
print(data["users"][27]["address"]["postalCode"])
print(data["users"][27]["company"]["address"]["postalCode"])
print(data["users"][27]["company"]["name"])
